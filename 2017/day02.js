const data = '157\t564\t120\t495\t194\t520\t510\t618\t244\t443\t471\t473\t612\t149\t506\t138\n' +
...
function calculatePart2 (spreadsheet) {
  return spreadsheet.split('\n')
      .map((row) => {
        let sorted = row.split('\t').sort((a, b) => {
          return parseInt(a, 10) - parseInt(b, 10);
        ...
        // quick'n dirty... maybe there is an whole better solution?!
...
console.log(`result part2: ${calculatePart2(data)}`);